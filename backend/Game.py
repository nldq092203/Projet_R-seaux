                ...
                if data:
                    ...
                    match(int(data["action_type"])):
                        ...
                        case NetworkCommandsTypes.BOB_EATEN:
                            self.grid.removeBob(x=int(data["position"][0]), y=int(data["position"][1]),bobID=int(data["id"]), player_id=int(data["energy"]), x=int(data["position"][0]), y=int(data["position"][1]))
