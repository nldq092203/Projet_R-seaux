...
class Grid:
    ...
    def removeBob(self,bobID, x, y, player_id = None):
        """
        ...
        cell.removeBob(bobID, player_id)
    ...
    def newTickEvents(self):
        ...
        for b in bobsList:
            if Settings.enableMovement and b.action == "idle":
                if b not in my_bobs_list or (b in my_bobs_list and b.newX == b.currentX and b.newY == b.currentY):
                    self.moveBob(b)
